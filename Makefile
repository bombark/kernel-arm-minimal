all:
	arm-none-eabi-as -mcpu=arm926ej-s src/startup.s -o startup.o
	arm-none-eabi-gcc -c -mcpu=arm926ej-s -o main.o  src/main.c
	arm-none-eabi-ld -T etc/main.ld main.o startup.o -L /usr/lib/gcc/arm-none-eabi/6.3.1/ -lgcc -o kernel.elf
